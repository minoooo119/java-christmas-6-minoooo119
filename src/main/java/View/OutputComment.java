...
public class OutputComment {
    public static final String OPENING_TITLE="12월 %d일에 우테코 식당에서 받을 이벤트 혜택 미리 보기!";
    public static final String MENU_TITLE="<주문 메뉴>";
    public static final String ORIGINAL_PRICE_TITLE="<할인 전 총주문 금액>";
    public static final String GIFT_MENU_TITLE="<증정 메뉴>";
